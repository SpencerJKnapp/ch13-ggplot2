...
ggplot(diamonds_sample, aes(x = carat, y = cut)) +
...
ggplot(data = diamonds_sample) +
  ...
  scale_y_reverse() +
  coord_flip()
#showing how to add color, reverse scale, flip coordinates
#pie charts are also available
#Facets break plots into different parts (like group_by()in dplyr)
